...
public final class EnumEditorWrapper extends InputWidgetWrapper<Enum<?>> {
    private final CycleButton<Enum<?>> button;

    public EnumEditorWrapper(Font font, int i, int j, int k, int l, Component component, Enum<?> initValue) {
